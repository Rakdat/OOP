server {
    port = 8080
    tickRateMs = 75 // Скорость игры (чем меньше, тем быстрее змея)
}

game {
    logic {
        ticksBeforeChange = 33  // Тиков до смены камней (10 сек)
        transitionTicks = 10    // Тиков на мигание камней (3 сек)
